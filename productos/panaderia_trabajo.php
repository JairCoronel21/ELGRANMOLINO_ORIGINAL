                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img width="100" src="data:image/jpeg;base64,<?php echo  base64_encode($row['imagen_prod']); ?>"></td>
                                <td><?php echo $dato->id_cat; ?></td>
                                <td><a class="text-success" href="crud/actualizar_productos.php?php echo $dato->id_producto; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="crud/eliminiar_productos.php?php echo $dato->id_producto; ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
            ...
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrar.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="txtdetalles" autofocus required>
                    </div>
                    <div class="mb-3">
